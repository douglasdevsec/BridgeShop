 ...
 */
export function getDelegateManager(request: BridgeShopRequest) {
 ...
 */
export function hasDelegate(id: string, request: BridgeShopRequest): boolean {
...
export function getDelegates(request: BridgeShopRequest): Record<string, any> {
