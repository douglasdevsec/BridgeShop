...
export default async function TailwindLoader(c) {
  ...
  mergedTailwindConfig.content = [
    // All file in packages/BridgeShop/dist and name is capitalized
    join(CONSTANTS.ROOTPATH, 'packages', 'BridgeShop', 'dist', '**', '[A-Z]*.js'),
    // All file in node_modules/@bridgeshop/BridgeShop/dist and name is capitalized
    join(
      CONSTANTS.ROOTPATH,
      'node_modules',
      '@BridgeShop',
