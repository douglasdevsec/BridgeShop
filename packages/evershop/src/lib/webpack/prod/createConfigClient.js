  ...
  config.optimization = {
    ...
    splitChunks: {
      ...
      cacheGroups: {
        ...
        // Excludes @bridgeshop/BridgeShop core and extensions
        adminVendor: {
          test: (module) => {
            ...
            // Exclude @bridgeshop/BridgeShop core package
            if (
              normalizedResource.includes('node_modules/@bridgeshop/BridgeShop')
            ) {
              return false;
            }
